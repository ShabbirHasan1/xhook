...
var xhook = (function () {
  ...
  //browser's FormData
  var Native$2 = windowRef.FormData;

  //xhooks's FormData
  const Xhook$2 = function(form) {
    this.fd = form ? new Native$2(form) : new Native$2();
    this.form = form;
    const entries = [];
  ...
  var FormData = {
    patch() {
      if (Native$2) {
        windowRef.FormData = Xhook$2;
      }
    },
    unpatch() {
      if (Native$2) {
        windowRef.FormData = Native$2;
      }
    },
    Native: Native$2,
    Xhook: Xhook$2
